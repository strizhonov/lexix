package com.strizhonovapps.lexicaapp.viewsupport.blur
...
object Blur {
    ...
    fun of(context: Context, source: Bitmap, factor: BlurFactor): Bitmap? {
        ...
        bitmap = try {
            ...
            stack(bitmap, factor.radius)
        }
        return if (factor.sampling == 1) {
            bitmap
        } else {
    ...
    private fun stack(sentBitmap: Bitmap, radius: Int): Bitmap? {
        val bitmap: Bitmap = sentBitmap
